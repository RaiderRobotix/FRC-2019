...
/**
* VisionPipeline implementation for retroflective tape.
* Tuned and generated using GRIP
*
...
public class GripPipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double[] hslThresholdHue = {66.36690647482014, 143.3276740237691};
		double[] hslThresholdSaturation = {0.0, 159.75382003395586};
		double[] hslThresholdLuminance = {105.48561151079137, 255.0};
